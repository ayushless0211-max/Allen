...
// ----------------------------------------------------
// TOKEN ACCESS MANAGER (Moved to Client-side Firebase)
// ----------------------------------------------------
// This was moved to the frontend via Firebase to support
// serverless deployments like Vercel which cannot run Express.
